...
var gfx =  {
	...
	video { 
		...
		if(this.movepos > 910 && this.movepos < 1366 ) { 
		...
		if(this.movepos > 455 && this.movepos < 910) { 
                        this._coreDoc.getElementById("tab1").className="cor_tab1";
		...
		if(this.movepos > 0  && this.movepos < 455) { 
...
<img src="http://tv.softwarelivre.org/themes/tvsl/logo.png" height="110"/>
<img src="org/fisl/brand/fisl-banner-fisl.png" height="110"/>
<img src="org/fisl/brand/fisl-banner-logo.png" height="110"/>
</div>
</td>
</tr>
</table>
