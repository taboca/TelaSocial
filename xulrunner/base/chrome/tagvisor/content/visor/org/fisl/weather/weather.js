...
var clock_Widget =  {
	...
	start : function () { 
		...
		mainDiv.setAttribute("style","text-align:center;padding:10px;-moz-border-radius:25px; margin-top:0px;margin-left:80px;width:320px;  height:180px;color:black; ; overflow:hidden; ");
