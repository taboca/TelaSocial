...
//   register("/main/header/cabecalho", "clock", "./tempo/index.html", iframeTemplate);
   ...
   //register("/main/lado", "abas-meio", "./abas/index.html", iframeTemplate);
   register("/main/lado", "sidebar", "./defesas-mini/index.html", iframeTemplate);
   register("/main/middle", "noticias", "./noticias/index.html", iframeTemplate);
  // register("/main/middle", "noticias", "./noticias-middle/index.html", iframeTemplate);
   //register("/main/middle", "meio", "./abas/index.html", iframeTemplate);
   register("/main/topmiddle", "mid", "./destaques/index.html", iframeTemplate);
   register("/main/bottomsection", "grade", "./grade/index.html", iframeTemplate);
   compile();   
